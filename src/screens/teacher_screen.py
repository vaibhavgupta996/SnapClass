...
def teacher_tab_take_attendence():
    ...
    with c2:
        if st.button('Run Face Anallysis', width='stretch', type='secondary', icon=':material/analytics:', disabled=not has_photos):
...
def teacher_screen_login():
    ...
    teacher_username=st.text_input("Enter Username", placeholder='Vaibhav Gupta')
...
def register_teacher(teacher_username, teacher_name, teacher_pass, teacher_pass_confirm):
    ...
    if check_teacher_exists(teacher_username):
        return False, "Username Already Taken, Please Type Something Else"
...
def teacher_screen_register():
    ...
    teacher_username=st.text_input("Enter Username", placeholder='@VBGupta')
    teacher_name=st.text_input("Enter Name", placeholder='Vaibhav Gupta')
    teacher_pass=st.text_input("Enter Password", type='password', placeholder="Enter Password")
